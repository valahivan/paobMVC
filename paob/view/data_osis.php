        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php?route=daftar">Daftar</a></li>
      ...
      <div class="card">
        ...
        <div class="card-body">
            <div class="alert alert-info alert-dismissible fade show" role="alert">
                <strong>Informasi !! </strong> Silahkan cek nama kamu dikolom pencarian. Kamu juga bisa download
                <strong>BUKTI PENDAFTARAN</strong>
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <table id="dataOSIS1" class="table table-bordered table-striped table-hover">
                <thead>
                ...
                <tbody>
                  <?php $nomor = 1 ?>
                    ...
                    <tr>
                        ...
                        <td class="align-middle"><?= strtoupper($row->no_hp); ?></td>
                        <td class="align-middle text-center">
                          <a href="index.php?route=download&&id=<?=$row->id?>" class="btn btn-primary font-weight-bold"><i class="fas fa-download"></i> DOWNLOAD BUKTI DAFTAR</a>
                        </td>
                    </tr>
                    <?php $nomor++ ?>
                    <?php endforeach ?>
